...
\begin{warnbox}[ANALYSIS: 个人定制分析 / Personalized Analysis]
\textbf{CN}: 此表格基于你的学习记录自动生成。\\
\textbf{EN}: This table is auto-generated from your study records.\\[0.5em]
\textbf{专业方向}: Power Engineering (EN1/EN2)
\end{warnbox}
...
\begin{center}
\small
\begin{tabular}{|p{1.2cm}|p{4.5cm}|c|p{5.0cm}|}
\hline
\rowcolor{gray!30} \textbf{Topic} & \textbf{Course / 科目} & \textbf{Priority} & \textbf{Strategy / 策略} \\ \hline
\multicolumn{4}{|c|}{\cellcolor{blue!10}\textbf{MATHEMATICS 数学}} \\ \hline
1 & BE5B01LAL Linear Algebra & \textcolor{red}{\textbf{CRITICAL}} & \textbf{SURVIVAL}: 背公式，不推导 \\ \hline
2,3 & BE5B01DEN Numerical+DiffEq & \textcolor{red}{\textbf{CRITICAL}} & \textbf{SURVIVAL}: Newton-Raphson 记死 \\ \hline
4,5 & BE5B01DMG Discrete+Graph & \textcolor{red}{\textbf{CRITICAL}} & \textbf{SURVIVAL}: 集合论+图遍历 \\ \hline
6 & BE5B01PRS Probability & \textcolor{green}{\textbf{SHOW OFF}} & \textbf{ATTACK}: Bayes→传感器融合 \\ \hline
\multicolumn{4}{|c|}{\cellcolor{yellow!10}\textbf{PHYSICS 物理}} \\ \hline
7,8,9 & BE5B02PH1 Physics 1 & \textcolor{orange}{\textbf{CAUTION}} & \textbf{FOCUS}: F=ma→加速度计原理 \\ \hline
10,11 & BE5B02PH2 Physics 2 & \textcolor{orange}{\textbf{CAUTION}} & \textbf{FOCUS}: 热力学→ESP32散热 \\ \hline
\multicolumn{4}{|c|}{\cellcolor{green!10}\textbf{EECS CORE 电子信息核心}} \\ \hline
12 & BE5B31ZEO Circuits & \textcolor{orange}{\textbf{CAUTION}} & \textbf{FOCUS}: KVL/KCL→传感器电路 \\ \hline
13,14 & BE5B34ELP Electron Devices & \textcolor{green}{\textbf{SHOW OFF}} & \textbf{ATTACK}: 半导体→你很熟练! \\ \hline
15 & BE5B34MIK Microcontrollers & \textcolor{green}{\textbf{SHOW OFF}} & \textbf{ATTACK}: ESP32是你的主场! \\ \hline
16 & BE5B33PRG/PGE Algorithms & \textcolor{blue}{\textbf{STABLE}} & \textbf{HOLD}: 基础数据结构即可 \\ \hline
\end{tabular}
\end{center}
...
\begin{tabular}{|p{1.2cm}|p{4.5cm}|c|p{5.0cm}|}
\hline
\rowcolor{gray!30} \textbf{Topic} & \textbf{Course / 科目} & \textbf{Status} & \textbf{Notes / 备注} \\ \hline
\multicolumn{4}{|c|}{\cellcolor{green!20}\textbf{[YOUR SPECIALIZATION] 你的专业方向}} \\ \hline
22 & BE5B15EN1/EN2 Power Eng. & \textcolor{blue}{\textbf{FOCUS}} & \textbf{TARGET}: 电网+变压器 \\ \hline
18 & BE5B35LSP Logic Systems & \textcolor{blue}{\textbf{BACKUP}} & 可作为备选专业题 \\ \hline
20 & BE5B14SP1 Elec. Machinery & \textcolor{red}{\textbf{AVOID}} & 基础薄弱，避免选此题 \\ \hline
21 & BE5B13MVE Materials & \textcolor{red}{\textbf{AVOID}} & 基础薄弱，避免选此题 \\ \hline
\multicolumn{4}{|c|}{\cellcolor{red!10}\textbf{[CRITICAL] SURVIVAL MODE 求生模式}} \\ \hline
23 & BE5B33KUI AI/Cybernetics & \textcolor{red}{\textbf{CRITICAL}} & \textbf{SURVIVAL}: BFS/DFS+状态空间 \\ \hline
\multicolumn{4}{|c|}{\cellcolor{gray!20}\textbf{[SKIP] OUT OF SCOPE 不在考试范围}} \\ \hline
17 & BE5B17EMT EM Theory & \textcolor{gray}{SKIP} & 未修课，跳过 \\ \hline
19 & BE5B31TES Signals & \textcolor{gray}{SKIP} & 未修课，跳过 \\ \hline
24 & BE5B35APO Architecture & \textcolor{gray}{SKIP} & 未完成考试，跳过 \\ \hline
25 & BE5B35ARI Control & \textcolor{gray}{SKIP} & 未完成考试，跳过 \\ \hline
\end{tabular}
\end{center}
...
\textcolor{red}{[CRITICAL]} Math & 5h & LAL/DEN/DMG 公式背诵 \\ \hline
\textcolor{red}{[CRITICAL]} KUI & 1h & BFS/DFS/A*状态搜索 \\ \hline
\textcolor{orange}{[CAUTION]} Physics & 4h & 力学+热力学基础 \\ \hline
\textcolor{orange}{[CAUTION]} Circuits & 2h & KVL/KCL 计算练习 \\ \hline
\textcolor{green}{[SHOW OFF]} MIK/ELP & 2h & 论文桥接准备 \\ \hline
