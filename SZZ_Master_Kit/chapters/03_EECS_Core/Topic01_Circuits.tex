...
\section{Circuit Analysis / 电路分析 (ZEO)}

\begin{warnbox}[\textcolor{orange}{\textbf{[CAUTION]}} PRIORITY: FOCUS MODE / 优先级：专注模式]
\textbf{[CN]} 电路优先级为 \textbf{CAUTION}。 \textbf{练习}: KVL/KCL 计算！
\textbf{[EN]} Circuits priority is \textbf{CAUTION}. Practice KVL/KCL calculations.\\
\textbf{Bridge to Thesis}: Sensor interface circuits! 传感器接口电路！\\
