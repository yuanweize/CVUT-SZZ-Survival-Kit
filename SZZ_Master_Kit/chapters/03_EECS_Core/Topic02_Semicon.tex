...
% Course: BE5B34ELP
% GRADE: B | PRIORITY: [SHOW OFF]
% ============================================
\section{Semiconductors / 半导体物理 (BE5B34ELP)}

\begin{tipbox}[\textcolor{green}{\textbf{[GOOD]}} GRADE B: CONFIDENT MODE / 成绩B：自信模式]
\textbf{[CN]} ELP成绩是 \textbf{B}，你对半导体比较熟悉！论文中的TCS34725光电二极管就是PN结应用！\\
\textbf{[EN]} ELP grade is \textbf{B}. You're comfortable with semiconductors! TCS34725 in your thesis = PN junction application!\\
\textbf{Thesis Link}: TCS34725光电二极管 → PN结的光伏特性 → 电子-空穴对生成
\end{tipbox}
