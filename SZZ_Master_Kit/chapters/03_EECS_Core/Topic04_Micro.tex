...
% PRIORITY: [SHOW OFF] (YOUR STRONGEST SUBJECT!)
% ============================================

\section{Microcontrollers / 微控制器 (MIK)}

\begin{tipbox}[\textcolor{green}{\textbf{[STAR]}} PRIORITY: SHOW OFF MODE / 优先级：展示模式]
\textbf{[CN]} 这是你的主场！ \textbf{Thesis = Embedded System}. Show them you are an expert.
\textbf{[EN]} This is your home turf. \textbf{Thesis = Embedded System}. Show them you are an expert.\\
\textbf{Key Weapon}: Interrupts, DMA, Timers (ESP32 specific).
