% ============================================
% Topic 06: Power Engineering / 电力工程
% Course: BE5B15EN1/EN2 (Your Specialization!)
% GRADE: B/C | PRIORITY: [SPECIALIZATION FOCUS]
% ============================================
\section{Power Engineering / 电力工程 (EN1/EN2)}

\begin{tipbox}[\textcolor{blue}{\textbf{[SPECIALIZATION]}} YOUR SPECIALIZATION / 你的专业方向]
\textbf{[CN]} EN1/EN2 是你的\textbf{专业选修题来源}。考试会从这里出1道专业题！\\
\textbf{[EN]} EN1/EN2 is your \textbf{Specialization Topic Source}. 1 exam question WILL come from here!\\
\textbf{Focus}: 发电厂类型 | 输配电网络 | 变压器原理 | 功率因数校正
\end{tipbox}
