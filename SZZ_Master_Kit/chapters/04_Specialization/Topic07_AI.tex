...
% ============================================
\section{Artificial Intelligence / 人工智能 (BE5B33KUI)}

\begin{warnbox}[\textbf{[WARN]} GRADE E DETECTED: SURVIVAL MODE / 成绩E：求生模式]
\textbf{[CN]} KUI成绩是 \textbf{E}。\textbf{只背核心概念}：状态空间搜索 (BFS/DFS/A*) + 启发式函数！\\
\textbf{[EN]} KUI grade is \textbf{E}. \textbf{ONLY memorize}: State Space Search (BFS/DFS/A*) + Heuristics!\\
